...
static QList<Msv::Core::StepDescriptor> buildScenarioSteps()
{
    ...
    return {
		...
		{9, StepType::Automatic,      "Проверка USB-носителя",         "Провека наличия и CRC эталонных файлов. \nНаличие и проверка time_security.cfg", 0},
		{10, StepType::Automatic,      "Формирование протокола",        "Автоматическая генерация протокола проверки в файл.", 10},
    };
}
